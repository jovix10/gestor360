    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-white">
      <div className="hidden lg:flex relative overflow-hidden bg-[#09090B]">
        ...
        <div className="relative z-10 flex flex-col justify-between p-14 text-white w-full">
          ...
          <div>
            ...
            <p className="mt-6 text-zinc-300 max-w-md">Como dono, você entra com seu email e senha ou com sua conta Google, sem precisar do código da empresa.</p>
          </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm">
          ...
          <Button data-testid="google-login-btn" onClick={googleLogin} variant="outline" className="w-full mt-8 h-11 border-zinc-200 hover:border-zinc-900 hover:bg-white">
